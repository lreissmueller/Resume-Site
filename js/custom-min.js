jQuery(document).ready((function() {
  $(".skills li .rating").each((function(t, i) {
    for (var a = 7, n = $(i).attr("data-rat"); a > 0;) $(i).append("<span></span>"), a--;
    $(i).find("span").each((function(t, i) {
      if (t >= n) return !1;
      $(i).animate({
        opacity: 1
      })
  ...
  t.easytabs({
  ...
  }), t.find(".tabs li a").hover((function() {
    $(this).stop().animate({
      marginTop: "-7px"
    }, 200)
  }), (function() {
    ...
    $(this).parent().parent().find("a").removeClass("current"), $(this).addClass("current")
  }));
